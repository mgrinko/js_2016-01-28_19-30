...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhoneCatalogue = __webpack_require__(22);
	var PhoneViewer = __webpack_require__(93);
	var Filter = __webpack_require__(114);
	var Sorter = __webpack_require__(115);
	...
	var Page = function () {
	  ...
	  (0, _createClass3.default)(Page, [{
	    ...
	    key: '_onPhonesSyncSuccess',
	    value: function _onPhonesSyncSuccess(phones) {
	      var filteredPhones = this._filterPhonesOnClient(phones);
	
	      this._phoneCatalogue.show(filteredPhones);
	    }
	  }, {
	    key: '_onPhonesSyncError',
	    value: function _onPhonesSyncError(error) {
	      console.error(error);
	    }
	  }, {
	    key: '_filterPhonesOnClient',
	    value: function _filterPhonesOnClient(phones) {
	      var normalizedQuery = this._query.toLowerCase();
	    ...
	    key: '_syncPhones',
	    value: function _syncPhones(query) {
	      this._ajax('/data/phones.json?query=' + encodeURIComponent(query)).then(this._onPhonesSyncSuccess.bind(this), this._onPhonesSyncError.bind(this));
	    }
	  }, {
	    key: '_ajax',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compiledTemplate = __webpack_require__(90);
	...
	var PhoneCatalogue = function (_Component) {
	  ...
	  (0, _createClass3.default)(PhoneCatalogue, [{
	    ...
	    value: function _onPhoneClick(event) {
	      ...
	      var element = link.closest('[data-selector="phoneItemContainer"]');
	      var phoneId = element.dataset.id;
	    ...
	    value: function show(phones) {
	      ...
	      (0, _get3.default)((0, _getPrototypeOf2.default)(PhoneCatalogue.prototype), 'show', this).call(this);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compiledTemplate = __webpack_require__(94);
